  ...
  <div class="comment_section">
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <button class="btn btn-primary" onclick="clicked()" style="float: right;">POST</button>
      </div>
    </div>
      ...
      <div class="col-md-12">
        <h3>4 Comments</h3>
         ...
         <div class="userscomments">
          <div class="comments">
            <div class="user">Sahil Mandal<span class="time">2021/11/08</span></div>
            <div class="usercomment">How far is kathmandu from Pokhara?</div>
            <div class="rpy-button"> <strong>reply</strong> </div>
            <div class="reply">
              <div class="comments">
                <div class="user">Deepak Gautam<span class="time">2021/11/9</span></div>
        ...
        <div class="userscomments">
          <div class="comments">
            <div class="user">Bipin Adhikari<span class="time">2021/05/24</span></div>
            <div class="usercomment">How long does Annapurna trek take to complete?</div>
            <div class="rpy-button"> <strong>reply</strong> </div>
            <div class="reply">
              <div class="comments">
                <div class="user">Sahil Mandal<span class="time">2021/07/12</span></div>
...
<footer class="clear">
  <div class="footer-container">
      ...
      <div class="footer-right">
        <h5> ©Copyright-nepalvisit.com | Developed by Sahil Mandal, Bipin Adhikari and Deepak Gautam
      </div>
  </div>
  </footer>
  ...
  <script>
        function clicked(){
          alert ("Sorry, but you must be logged in");
        }
  </script>
