...
<head>
  ...
  <link rel="stylesheet" href="public/css/destination1.css">
  ...
  <div class="container">
    ...
    <div class="kathmandu">
        ...
        <div class="ktm_valley1">
          <img src="public/img/destination/Pokhara/pokhara1.jpg" alt="Pokhara" style="width:100%; height:70%;" class="image1">
          <div class="overlay1">
    ...
    <div class="chitwan">
        <h1 style="text-align:center">Chitwan</h1>
          <img src="public/img/destination/Chitwan/crocodile.jpg" alt="crocodile">
          <img src="public/img/destination/Chitwan/elephant.jpg" alt="elephant">
          <img src="public/img/destination/Chitwan/rhino.jpg" alt="rhino">
    ...
    <div class="kathmandu" class="clear">
        ...
        <div class="ktm_valley1">
          <img src="public/img/destination/Mountaineering/mountaineering-in-nepal.jpeg" alt="Mt.Everest" style="width:100%; height:70%;" class="image1">
          <div class="overlay1">
      ...
      <div class="kathmandu">
          ...
          <div class="ktm_valley1">
            <img src="public/img/destination/Everest/everest2.jpg" alt="Mt.Everest" style="width:100%; height:70%;" class="image1">
            <div class="overlay1">
...
The Everest region in Nepal is more than just climbing and trekking, it is a life changing experience and some see it as a journey close to achieving.....<a href="">read more</a></div>
    ...
    <div class="kathmandu" class="clear">
        ...
        <div class="ktm_valley1">
          <img src="public/img/destination/Annapurna/annapurna-circuit.jpg" alt="Annapurna" style="width:100%; height:70%;" class="image1">
          <div class="overlay1">
      ...
      <img src="public/img/destination/Annapurna/annapurna1.jpg" alt="Annapurna" class="annapurna-image">
      <img src="public/img/destination/Annapurna/annapurna2.jpg" alt="Annapurna" class="annapurna-image">
    </div>

    <div class="sagarmatha" class="clear">
        <h1 style="text-align:center">SAGARMATHA NATIONAL PARK</h1>
          <img src="public/img/destination/Everest/Sagarmatha National Park/everest-mp-adventure.jpeg" alt="crocodile">
          <img src="public/img/destination/Everest/Sagarmatha National Park/gokyo.jpg" alt="elephant">
          <img src="public/img/destination/Everest/Sagarmatha National Park/yak.jfif" alt="rhino">
