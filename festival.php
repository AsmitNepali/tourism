<?php
  ...
  if (array_key_exists("logout", $_GET)) {
    ...
    session_destroy();
        ...
        header("Location: festival_loggedin.php");
...
<head>
  ...
  <link rel="stylesheet" href="public/css/festival1.css">
...
<div class="page">
  <div class="container">
    <div class="kathmandu">
        ...
        <img src="public/img/photo/abc.jpg" alt="kathmandu" style="width:100%; height:70%;">
    ...
    <div class="kathmandu">
        ...
        <div class="ktm_valley1">
          <img src="public/img/photo/dashain2.jpg" alt="Pokhara" style="width:100%; height:70%;" class="image1">
    ...
    <div class="chitwan">
        <h1 style="text-align:center">TIHAR</h1>
          <img src="public/img/photo/kukutihar.jpg" alt="crocodile">
          <img src="public/img/photo/tihar4.png" alt="elephant">
          <img src="public/img/photo/tihar2.jpg" alt="rhino">
          <img src="public/img/destination/Chitwan/tiger.jpg" alt="tiger">
    ...
    <div class="kathmandu" class="clear">
        ...
        <div class="ktm_valley1">
          <img src="public/img/photo/chatth1.jpeg" alt="Mt.Everest" style="width:100%; height:70%;" class="image1">
      ...
      <div class="kathmandu">
          ...
          <div class="ktm_valley1">
            <img src="public/img/photo/lhosar.jpg" alt="Mt.Everest" style="width:100%; height:70%;" class="image1">
    ...
    <div class="kathmandu" class="clear">
        ...
        <div class="ktm_valley1">
          <img src="public/img/photo/holi2.jpg" alt="Annapurna" style="width:70%; height:70%;" class="image1">
      </div>
      <img src="public/img/photo/holi.jpg" alt="Annapurna" class="annapurna-image">
      <img src="public/img/photo/holi1.jpg" alt="Annapurna" class="annapurna-image">
      <h7>March 09, 2020</h7>
    ...
    <div class="sagarmatha" class="clear">
        <h1 style="text-align:center">SHIVARATRI</h1>
          <img src="public/img/photo/shivaratri.jpeg" alt="crocodile">
          <img src="public/img/photo/shivaratri1.jpeg" alt="elephant">
          <img src="public/img/photo/shivaratri2.jpg" alt="rhino">
    ...
    <div class="kathmandu">
        ...
        <div class="ktm_valley1">
          <img src="public/img/photo/ghodejatra.jpg" alt="Mt.Everest" style="width:100%; height:70%;" class="image1">
          <h7>March 24, 2020</h7>
    ...
    <div class="kathmandu">
        ...
        <div class="ktm_valley1">
          <img src="public/img/photo/bisketjatra.jpg" alt="Mt.Everest" style="width:100%; height:70%;" class="image1">
          <h7>April 13, 2020</h7>
...
On this day, children (including adult children!) offer sweets, fruits and gifts to their mothers to show their respect and gratitude. Those whose mothers have passed away visit Mata Tirtha in the west of Kathmandu, take a holy bath and make offerings in their mother’s memory.</p>
    ...
    <div class="kathmandu">
        ...
        <div class="ktm_valley1">
          <img src="public/img/photo/buddhajayan.jpg" alt="Mt.Everest" style="width:100%; height:70%;" class="image1">
          <h7>May 7, 2020</h7>
    ...
    <div class="kathmandu">
        ...
        <div class="ktm_valley1">
          <img src="public/img/photo/rato machindranath.jpg" alt="Mt.Everest" style="width:100%; height:70%;" class="image1">
          <h7>May-June 2020</h7>
    ...
    <div class="kathmandu">
        ...
        <div class="ktm_valley1">
          <img src="public/img/photo/janaipurnima.jpg" alt="Mt.Everest" style="width:100%; height:70%;" class="image1">
          <h7>August 3, 2020</h7>
    ...
    <div class="kathmandu">
        ...
        <div class="ktm_valley1">
          <img src="public/img/photo/gaijatra.jpg" alt="Mt.Everest" style="width:100%; height:70%;" class="image1">
    ...
    <div class="kathmandu">
        ...
        <div class="ktm_valley1">
          <img src="public/img/photo/teej.jpg" alt="Mt.Everest" style="width:100%; height:70%;" class="image1">
